...
<div class="w3-half" style="padding-right: 6px; padding-top: 8px; padding-left: 16px;"  >
    ...
    <div class="w3-row "style="height: 380px; border-radius: 30px 0px 0px 30px;">
...
<div class="w3-half" style="height: 380px;">
    <div class="w3-half" style="padding-top:8px;">
        <div class="w3-row " style="height: 187px;">
        ...
        <div class="w3-row " style="height: 187px; margin-top: 6px;">
