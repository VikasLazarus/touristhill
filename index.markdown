...
---
  <div class="w3-row">
    ...
    <div id="Explore" class="city">
      ...
      <div class="w3-row w3-sand s12 m3 l3 w3-center  w3-container w3-hide-large w3-hide-medium"
        style="height: 50px; display: flex; align-items: center; justify-content: center; padding: 3px 20px;">
        <div class="w3-col  s6 m6 l6 w3-button w3-teal w3-small "
          style=" border-radius: 30px 0px 0px 30px;">
          <strong>Tours</strong>
        </div>
        <div class="w3-col  s6 m6 l6 w3-button  w3-small w3-white" style="border-radius: 0px 30px 30px 0px;">
      ...
      <div class="w3-large w3-content w3-padding w3-text-dark-gray">
        <h2 class="w3-large w3-col s8 m8 l8"><strong>Tours In Shimla</strong></h2> <span
          class="w3-right w3-col w3-text-teal w3-small" style="width: 70px;">View All <i
      ...
      <div class="swiper mySwiper2 w3-content w3-padding">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide-2 w3-row">
            ...
            <a href="tours/shimla-manali-adventure-package.html">
...
<div class="w3-row" style="padding: 3px 12px; border-radius: 7px;background-image: linear-gradient(#ff572226, #ffffff00);" >
  ...
  " stroke-width="2">
      ...
      <div class="w3-large w3-content w3-padding w3-text-dark-gray">
        <h2 class="w3-large w3-col s8 m8 l8"><strong>Tours In manali</strong></h2> <span
          class="w3-right w3-col w3-text-teal w3-small" style="width: 70px;">View All <i
            style="padding:3px 5px; border-radius: 30px; margin-top: 15px;"
            class="w3-card w3-teal fa-solid fa-angle-right"></i></span>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide-2 w3-row">
            ...
            <a href="tours/shimla-manali-adventure-package.html">
              ...
              -webkit-line-clamp: 2;
              font-weight: 700;
              -webkit-box-orient: vertical;">Manali Honeymoon Package For 3 Days</h3>
